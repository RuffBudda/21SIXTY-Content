...
class PromptsService:
    ...
    def _get_default_prompts(self) -> Dict[str, str]:
        ...
        return {
            ...
            "chapter_timestamps": "Analyze this podcast transcript and create YouTube chapter timestamps based on the ACTUAL content and topic transitions in the transcript below.\n\nTranscript with timecodes:\n{transcript_with_timecodes}\n\nVideo duration: {video_duration} seconds\n\nIMPORTANT: Your chapter timestamps MUST be based on the actual topics and transitions that occur in the transcript above. Identify where the conversation naturally shifts topics based on what is actually discussed.\n\nCreate YouTube-ready chapter timestamps that:\n1. Identify natural topic breaks in the conversation based on the transcript content\n2. Use format: 00:00:00 - Chapter Title\n3. Create 8-12 meaningful chapters\n4. Each chapter title should be descriptive and engaging, reflecting the actual topics discussed\n5. Timestamps should align with topic transitions visible in the transcript\n\nReturn only the timestamps in this exact format:\n00:00:00 - Chapter Title 1\n00:05:30 - Chapter Title 2\n...",
