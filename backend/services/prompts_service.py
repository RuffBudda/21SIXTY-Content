...
class PromptsService:
    ...
    def _get_default_prompts(self) -> Dict[str, str]:
        ...
        return {
            ...
            "two_line_summary": "Create a concise two-line summary of this podcast episode.\n\nTranscript:\n{transcript}\n\nWrite exactly two lines that capture the essence of the episode. Make it engaging and informative.\n\nFormat:\nLine 1\nLine 2",
            "quotes": "Extract 20 of the most notable, insightful, or quotable statements from this podcast transcript.\n\nTranscript with timestamps:\n{transcript_with_timecodes}\n\nRequirements:\n- Select the 20 most impactful quotes\n- They should be complete thoughts or statements\n- Include the timestamp in format [HH:MM:SS] before each quote\n- Number each quote from 1 to 20\n- Return only the quotes, one per line\n\nFormat:\n1. [HH:MM:SS] Quote text here\n2. [HH:MM:SS] Quote text here\n...",
            "chapter_timestamps": "Analyze this podcast transcript and create YouTube chapter timestamps.\n\nTranscript with timecodes:\n{transcript_with_timecodes}\n\nVideo duration: {video_duration} seconds\n\nCreate YouTube-ready chapter timestamps that:\n1. Identify natural topic breaks in the conversation\n2. Use format: 00:00:00 - Chapter Title\n3. Create 8-12 meaningful chapters\n4. Each chapter title should be descriptive and engaging\n5. Timestamps should align with topic transitions\n\nReturn only the timestamps in this exact format:\n00:00:00 - Chapter Title 1\n00:05:30 - Chapter Title 2\n...",
            "linkedin_post": "Create a LinkedIn post for The Dollar Diaries podcast episode.\n\nGuest Information:\n- Name: {guest_name}\n- Title: {guest_title}\n- Company: {guest_company}\n\nTranscript:\n{transcript}\n\nCreate a LinkedIn post that includes:\n1. A compelling description of the guest (their background, expertise, and why they're interesting)\n2. Three key takeaways from the episode (numbered or bulleted)\n3. A call-to-action (CTA) that includes:\n   - Placeholder link to watch the episode on YouTube: [Watch on YouTube](YOUTUBE_LINK_PLACEHOLDER)\n   - Placeholder link to catch the takeaways in the newsletter: [Read in Newsletter](NEWSLETTER_LINK_PLACEHOLDER)\n\nMake it engaging, professional, and optimized for LinkedIn. Use line breaks for readability. Keep it concise but impactful."
        }
